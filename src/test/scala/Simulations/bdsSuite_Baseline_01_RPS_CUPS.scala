...
3. Inject 1 users per second at a constant rate of 2 minutes
4. Inject rampup to 1 request per second for 2 minutes
 */

class bdsSutie_Baseline_01_RPS_CUPS extends Simulation
{
